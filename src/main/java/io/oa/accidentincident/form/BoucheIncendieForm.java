...
public class BoucheIncendieForm {
	private Long id;
	...
	public BoucheIncendieForm(Long id, String description, String numberSerie, String dateAcquisition,
			String heureAcquisition, String dateMaintenance, String heureMaintenance, String datePeremption,
			String heurePeremption, String image, String emplacement, int nombrebouche, Long iddepartement) {
		super();
		this.id = id;
		this.description = description;
		this.numberSerie = numberSerie;
