...
public class RobinetIncendieForm {
	private Long id;
	...
	public RobinetIncendieForm(Long id, String description, String numberSerie, String dateAcquisition,
			String heureAcquisition, String dateMaintenance, String heureMaintenance, String datePeremption,
			String heurePeremption, String image, String emplacement, String length, String diametre,
			Long iddepartement) {
		super();
		this.id = id;
		this.description = description;
