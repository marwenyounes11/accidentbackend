...
public class PoteauxIncendieResponse {
	private Long id;
	...
	public PoteauxIncendieResponse() {
		super();
		// TODO Auto-generated constructor stub
	}
	public PoteauxIncendieResponse(Long id, String description, String numberSerie, Date dateAcquisition,
			Date heureAcquisition, Date dateMaintenance, Date heureMaintenance, Date datePeremption,
			Date heurePeremption, String image, String emplacement, String coleurpoteaux, Departement departement) {
		super();
		this.id = id;
		this.description = description;
		this.numberSerie = numberSerie;
